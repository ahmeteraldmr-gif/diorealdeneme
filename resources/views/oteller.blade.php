...
<body>
    ...
    <nav id="mainNav">
        ...
        <ul class="nav-links">
            ...
            <li><a href="{{ route('oteller') }}" class="active-page"><span class="lang-text-tr">Oteller</span><span class="lang-text-en">Hotels</span></a></li>
                ...
                <div class="hotel-row">
                    <div class="hotel-image-col">
                        @if($otel->show_video_on_cover && (!empty($otel->video_file) || !empty($otel->video_url)))
                            ...
                            @endif
                        @else
                            <img src="{{ dioreal_img($otel->img, 'foto.img/otel_hero.jpg') }}" onerror="this.onerror=null;this.src='{{ asset('foto.img/otel_hero.jpg') }}';" alt="{{ $otel->name['tr'] ?? '' }}" class="hotel-row-image" style="object-fit: cover;">
                        @endif
