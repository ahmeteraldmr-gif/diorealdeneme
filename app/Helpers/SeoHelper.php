...
if (!function_exists('get_page_seo')) {
    ...
    function get_page_seo(string $pageKey): array
    {
        $seoMap = [
            ...
            'sepet' => [
                'title_tr' => 'Sepetiniz — Dioreal Dijital Lüks Rezervasyon & Sipariş',
                'title_en' => 'Shopping Cart — Dioreal Digital Luxury Bookings',
                'desc_tr'  => 'Dioreal sepetinizdeki seçkin konaklama, yat kiralama ve gurme rezervasyonlarınızı inceleyin.',
                'desc_en'  => 'Review your curated luxury stays, private yacht charters, and gourmet reservations in your Dioreal cart.',
            ],
            'urunler' => [
                'title_tr' => 'Lüks Ürünler & Ayrıcalıklı Deneyim Koleksiyonu — Dioreal Dijital',
                'title_en' => 'Luxury Products & Exclusive Experiences Collection — Dioreal Digital',
                'desc_tr'  => 'Dioreal seçkin yaşam tarzı ürünleri, VIP concierge paketleri ve özel konaklama deneyimlerini keşfedin.',
                'desc_en'  => 'Explore Dioreal curated luxury lifestyle items, VIP concierge packages, and bespoke stay experiences.',
            ],
        ];
