...
const DEFAULT_CONTENT = {
    ...
    // Cart Page
    "cart_title": { "tr": "Sepetiniz", "en": "Shopping Cart" },
    "cart_desc": { "tr": "Seçkin rezervasyonlarınızı ve ürünlerinizi inceleyin, WhatsApp üzerinden doğrudan siparişinizi onaylayın.", "en": "Review your exclusive bookings and items, confirm your order directly via WhatsApp." },
    "cart_empty": { "tr": "Sepetiniz henüz boş.", "en": "Your cart is currently empty." },
    "cart_empty_sub": { "tr": "Ayrıcalıklı dünyamızı keşfedin ve rezervasyon paketinizi oluşturun.", "en": "Explore our exclusive offerings and create your custom booking package." },
    "cart_btn_products": { "tr": "Ürünleri Keşfet", "en": "Explore Products" },
    "cart_total": { "tr": "Toplam Tutar:", "en": "Total Amount:" },
    "cart_checkout_wa": { "tr": "WhatsApp ile Sipariş Ver", "en": "Order via WhatsApp" },
    "cart_clear": { "tr": "Sepeti Temizle", "en": "Clear Cart" },

    // Products Page
    "prod_hero_brand": { "tr": "MOJEA & DIOREAL HOME COLLECTION", "en": "MOJEA & DIOREAL HOME COLLECTION" },
    "prod_hero_title": { "tr": "Özel Koleksiyon & <em>Lüks Paketler</em>", "en": "Exclusive Collection & <em>Luxury Stays</em>" },
    "prod_hero_desc": { "tr": "Lüks yaşam alanları, VIP concierge deneyimleri ve seçkin destinasyon paketlerini keşfedin, sepetinize ekleyip rezervasyonunuzu yapın.", "en": "Discover luxury residences, VIP concierge experiences, and exclusive destination packages, add to cart, and complete your reservation." },
    "prod_filter_all": { "tr": "Tüm Ürünler", "en": "All Products" },
    "prod_btn_quick": { "tr": "Hızlı İncele", "en": "Quick View" },
    "prod_btn_add": { "tr": "Hızlı Ekle", "en": "Quick Add" },
    "prod_modal_add": { "tr": "SEPETE EKLE", "en": "ADD TO CART" }
};
